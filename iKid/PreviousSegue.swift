...
class PreviousSegue: UIStoryboardSegue {
	override func perform() {
		...
		UIView.transition(from: from!, to: to!, duration: 1, options: .transitionFlipFromLeft, completion: {(Finished) -> Void in self.source.present(self.destination as UIViewController, animated: false, completion: nil)})
